...
// __CYLONIX_MOD__ Match sessions_windows.go / mksyscall.go: this file
// uses types defined there, so exclude under ts_tcp_safesocket. The
// same constraint is in mksyscall.go so regeneration propagates it.
